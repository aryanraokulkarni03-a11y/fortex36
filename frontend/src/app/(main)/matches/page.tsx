            ...
            <main className="pt-24 pb-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <motion.div
                        ...
                        className="mb-8"
                    >
                        <h1 className="text-3xl font-bold text-foreground mb-2">Find Mentors</h1>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {popularSkills.map((skill) => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-full text-sm font-medium transition-smooth ${activeSearch === skill
                    ...
                    {showFilters && (
                        <motion.div
                            ...
                            className="mb-8 p-6 rounded-lg border border-border bg-card"
                        >
                        ...
                        {isError && (
                            ...
                            >
                                ...
                                <div className="flex gap-3 justify-center">
                                    ...
                                    <Button variant="outline" onClick={handleSeedDemo} loading={seedDemo.isPending}>
                                        Seed Demo Data
                                    </Button>
                                </div>
                            </motion.div>
